...
import 'package:fuodz/views/pages/delivery_address/new_ui_delivery_address.page.dart';
...
import 'package:fuodz/views/shared/location_fetch.page.dart';
...
Route<dynamic> generateRoute(RouteSettings settings) {
  switch (settings.name) {
    ...
    case AppRoutes.loginRoute:
      return MaterialPageRoute(builder: (context) => NewUILogin());
