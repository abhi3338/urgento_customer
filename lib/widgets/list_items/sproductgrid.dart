...
class SProductGridListItem extends StatefulWidget {
  const SProductGridListItem(this.product,
      {this.onPressed,
      @required this.qtyUpdated,
      this.height,
      this.onNewQtyUpdated,
      Key key})
      : super(key: key);
  ...
  final Function(Product, int, bool isIncrement, bool isDecrement)
      onNewQtyUpdated;
  final double height;

  @override
  State<SProductGridListItem> createState() => _SProductGridListItemState();
}

class _SProductGridListItemState extends State<SProductGridListItem> {
        ...
        VStack([
          ...
          Container(
            ...
            child: CustomVisibilty(
                visible: !widget.product.capacity.isEmptyOrNull &&
                    !widget.product.unit.isEmptyOrNull,
                            ...
                            Container(
                              ...
                              child: Text(
                                ...
                                style: TextStyle(
                                  ...
                                  // Add line-through decoration
                                  decorationColor: Colors.black,
                                  // Optionally, set the color of the line-through
                                  decorationThickness:
                                      1.5, // Optionally, adjust the thickness of the line-through
                                ),
                              ),
                            ),
                          ]),
                    ...
                    CustomVisibilty(
                      ...
                      child: StreamBuilder<List<Cart>>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            int searchIndex = tempCartData.indexWhere((element) =>
                              ...
                              CustomVisibilty(
                                ...
                                child: TextButton(
                                  ...
                                  style: TextButton.styleFrom(
                                    //<-- SEE HERE
                                    side: BorderSide(
                                        width: 2.0, color: Color(0xFF181725)),
