...
class OCustomTextFormField extends StatefulWidget {
  ...
  @override
  _OCustomTextFormFieldState createState() => _OCustomTextFormFieldState();
}

class _OCustomTextFormFieldState extends State<OCustomTextFormField> {
  @override
